...
{
  "dependencies": {
    "com.jtfrom9.naughtyattributes.required-guard": "https://github.com/jtfrom9/MustRequired.git?path=/Packages/com.jtfrom9.naughtyattributes.required-guard#v0.1.0",
